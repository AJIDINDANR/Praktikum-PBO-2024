// File: SistemPendataanProdukMakeUpDiTokoSubasic.java
package TokoMakeUp;
        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    // Menambahkan produk biasa atau diskon sesuai dengan input pengguna
                    System.out.print("Apakah produk diskon? (y/n): ");
                    ...
                    if (jawaban.equalsIgnoreCase("y")) {
                        ...
                        daftarProduk.add(new ProdukMakeUpDiskon(nama, harga, diskon));
                    } else {
